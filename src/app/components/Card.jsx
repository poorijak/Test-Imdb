  ...
  return (
    <div className='group cursor-pointer sm:hover:shadow-slate-400 sm:shadow-md rounded-lg sm:border sm:border-slate-400 sm:p-4 m-2'>
      <Link href={`/movie/${result.id}`}>
        <Image src={`https://image.tmdb.org/t/p/original/${result.backdrop_path || result.poster_path}`} width={500} height={500} className='sm:rounded-t-lg group-hover:opacity-20 transition-opacity duration-300' alt={result.original_title}></Image>
        <div>
